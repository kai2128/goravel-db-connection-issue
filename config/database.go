...
func init() {
	...
	config.Add("database", map[string]any{
		...
		"connections": map[string]any{
			...
			"mysql2": map[string]any{
				"driver":   "mysql",
				"host":     config.Env("DB2_HOST", "127.0.0.1"),
				"port":     config.Env("DB2_PORT", 3306),
				"database": config.Env("DB2_DATABASE", "forge"),
				"username": config.Env("DB2_USERNAME", ""),
				"password": config.Env("DB2_PASSWORD", ""),
				"charset":  "utf8mb4",
				"loc":      "Local",
				"prefix":   "",
				"singular": false, // Table name is singular
